...
urlpatterns = [
    ...
    path('posts/<int:post_id>/edit_comment/<int:comment_id>/', views.PostDeleteView.as_view(), name='edit_comment'),
    path('posts/<int:post_id>/delete_comment/<int:comment_id>/', views.PostDeleteView.as_view(), name='delete_post'),
